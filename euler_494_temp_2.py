...
def print_sequences(parent_tree_position, parent_value, parent_path_list, parent_bit_list):
	...
	if(even_child_tree_position >= 2 ** (sequence_length - 1)):
		...
		print_sequences(even_child_tree_position, next_even_number, even_path_list, even_bit_list)
	...
	if(odd_child_tree_position >= 2 ** (sequence_length - 1)):
		...
		print_sequences(odd_child_tree_position, int(next_odd_number), odd_path_list, odd_bit_list)
		return
